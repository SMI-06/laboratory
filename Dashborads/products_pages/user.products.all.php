            ...
            if (mysqli_num_rows($query) > 0) {
                while ($row = mysqli_fetch_assoc($query)) { ?>
                    <tr>
                        ...
                        <td><a href="product.edit.php?id=<?php echo $row['Product_code'] ?>" class="btn btn-outline-dark rounded-pill"><i class="fas fa-user-edit"></i></a></td>
