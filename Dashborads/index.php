...
<section class="main-section">
    ...
    <?php
    if (isset($userDetail['Role']) == "Super Admin") { ?>
    ...
    <?php }
    //  Admin Dashborad
    else if (isset($userDetail['Role']) == "admin") { ?>
        <?php
        $query = mysqli_query($conn, "SELECT 
                            SUM(CASE WHEN role = 'admin' THEN 1 ELSE 0 END) AS admin_count, 
                            SUM(CASE WHEN role = 'Tester' THEN 1 ELSE 0 END) AS tester_count, 
        ...
        <?php }
    //  Tester Dashborad
    else if (isset($testerDetails['Role']) == "Tester") {
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row g-4 mt-2">
                    <div class="col-sm-12 col-xl-12">
                        <div class="mycard shadow rounded d-flex align-items-center justify-content-center p-4">
                            <i class="fas fa-times fa-3x text-light"></i>
                            <div class="ms-3">
                                <h3 class="mb-2 text-light mt-2">Please Wait For Your Approval</h3>
                            </div>
