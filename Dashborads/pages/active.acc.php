...
<div class="container-fluid pt-4 px-4">
    <h3 class="text-dark text-center text-uppercase">All User</h3>
        ...
        <div class="bg-light rounded h-100 p-4 table-scrollable" style="overflow-x: scroll;">
            <table class="table table-hover" style="width:100%;">
                ...
                <tbody>
                    ...
                    <?php
                    $select = "SELECT * FROM `signup` where Role = 'User'";
                    ...
                    if (mysqli_num_rows($res)) {
                        while ($row = mysqli_fetch_assoc($res)) { ?>
                            <tr>
                                ...
                                <td><a href="user.edit.php?id=<?php echo $row['id'] ?>" class="btn btn-outline-dark rounded-pill">Edit</a></td>
                                <td><input type="submit" class="btn btn-outline-danger rounded-pill" value="Disable"></td>
                            </tr>
                        <?php }
                    } else { ?>
