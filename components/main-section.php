    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12 txtr">
                <h4 class="text-dark">Why Choose Us <br>
                    <span class="text-info">Laboratories</span>
                </h4>
            ...
            <div class="col-lg-6 col-md-12">
                <img src="assets/images/why.jpg"  class="rounded" style="box-shadow: 0px 0px 30px lightgray; z-index:1" alt="">
            </div>
        </div>
    </div>
</section>